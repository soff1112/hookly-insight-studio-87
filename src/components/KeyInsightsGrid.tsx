...
import { RefreshCw, ChevronRight, Database } from "lucide-react";
  ...
  <Card className={`p-5 border-2 ${bgClass} hover:shadow-card-hover transition-all duration-300 relative`}>
    ...
    <div className="space-y-3">
      <div className="flex items-start gap-3">
        ...
        <div>
          <Badge variant="secondary" className={`text-[10px] px-1.5 py-0 mb-1 ${priorityStyles[priority]}`}>
  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        ...
        subtitle="AI-generated recommendations with expected impact and data sources"
        timeRange="Last 7 days"
        dataScope="5 competitors"
        sampleSize="127 videos • 847 posts"
        tooltip="Each insight is generated by analyzing competitor patterns and your performance gaps. Click 'View data' to see the underlying metrics."
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <InsightCard
          icon="🚀"
          title="Hook Duration Optimization"
          bgClass="border-destructive/20 bg-destructive/5"
          priority="critical"
          dataSource="Based on 45 competitor videos with 10M+ views"
        ...
        <InsightCard
          ...
          priority="high"
          dataSource="Aggregated ER across 3 platforms • 183 videos"
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-1">
              <p>Your ER: <strong>4.2%</strong> vs Competitor Avg: <strong>6.8%</strong></p>
              <p className="text-xs">
                <Badge variant="secondary" className="text-[10px] bg-destructive/10 text-destructive">
                  -38% gap
                </Badge>
                {" "}TikTok has highest competitor ER (12.1%)
              </p>
            </div>
          </div>
        </InsightCard>
        ...
        <InsightCard
          ...
          priority="medium"
          dataSource="Top 10 viral videos from competitors • Last 30 days"
        ...
        <InsightCard
          ...
          priority="high"
          dataSource="847 competitor posts • ER by posting hour"
          onRegenerate={() => console.log("Regenerate insight")}
          onShowData={() => console.log("Show data")}
        >
          <p>
        ...
        <InsightCard
          ...
          priority="critical"
          dataSource="7-day posting cadence analysis • Top 5 competitors"
          onRegenerate={() => console.log("Regenerate insight")}
          onShowData={() => console.log("Show data")}
        >
